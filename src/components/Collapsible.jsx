...
function Collapsible({ id, borderColor, name, diagramId }) {
  ...
  return (
    <div
      className="w-full max-w-lg z-0 bg-white dark:bg-neutral-800 shadow-md border-l-4 transition duration-150 "
          ...
          >
            <div className="p-3 space-y-2">
              {columns && columns.map((col, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 border border-neutral-200 dark:border-neutral-700 rounded px-2 py-1 bg-neutral-100 dark:bg-neutral-900  transition-colors h-10"
                >
                  <input
                  ...
                  <div className="flex items-center h-full">
                    ...
                    >
                      ...
                      {openKeyMenu === col.id && (
                        <div className="absolute right-10 -top-4 w-40 bg-neutral-900 text-white shadow shadow-neutral-900 rounded p-2 z-100">
            ...
            {/* Footer */}
            <div className="flex gap-2 p-3 py-4 border-y border-neutral-200 dark:border-neutral-700">
              <button
                onClick={addColumn}
